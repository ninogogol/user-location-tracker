export class Users {
    ...
    async getAllUsers() {
        ...
        try {
            ...
            // Loop through each user and create an option element with their name and add an id
            users.forEach(user => {
    ...
    async getUserLocation(id, map) {
        ...
        try {
            ...
            map.setView([selectedUser.address.geo.lat, selectedUser.address.geo.lng], 3)
